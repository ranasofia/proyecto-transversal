...
const routes: Routes = [
  ...
  {path: 'hccauchos/factura', component: FacturaHCComponent, canActivate:[GuardianService]},
  {path: 'hccauchos/historial', component: HistorialComprasHCComponent, canActivate:[GuardianService]},
